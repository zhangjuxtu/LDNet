...
class Parameters():
    ...
    y_size = 256
    resize_ratio = 4
    grid_x = x_size // resize_ratio  #128
    grid_y = y_size // resize_ratio  #64
    pt_acc_thr = grid_y // 10
    feature_size = 4
    mode = 2
    threshold_conf = 0.65
    points_num = 64
    ...
    dynamic_sample_at = 50
    dynamic_sample_test = dynamic_sample_at + 1
    

    #los function parameter
    K1 = 1.0                     #  ####################################
    K2 = 2.0
    constant_offset = 1.0
    ...
    #train_root_url="/home/jun8/workspace/tuSimple/"
    train_root_url="/home/zhangjun/Downloads/tuSimple/"
    test_root_url = train_root_url 
